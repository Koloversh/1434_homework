...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Меня зовут " + gosha.getName() + "\nИмя моей мамы: " + eva.getName() + "\nИмя моего папы: " +
                alex.getName() + "\nУ меня две бабушки, бабушка " + olga.getName() + " и " + jula.getName() +
                "\nУ меня два деда, дед " + valera.getName() + " и " + oleg.getName());
...
class Person{
    ...
    //Здесь был кусок кода, который ни на что не влиял. Убрал.
}
